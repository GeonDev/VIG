					...
					<div class="input-group md-form form-sm form-1 pl-0 col-4">
						<div class="input-group-prepend">
							...
							<select class="form-control" name="searchCondition" style="width: 100px; ">
							 ...
							 <input id="inputKeyword" class="form-control form-control-sm ml-0 w-75" type="text" name="keyword" value="${search.keyword}" placeholder="Search" aria-label="Search">
						...
						<tbody>
							...
							<c:forEach var="user" items="${list}">
								...
								<tr>
									...
									<td scope="col"><i class="fas fa-check"></i> <input type="hidden" value="${user.userCode}"> <span id="${user.userCode}"> </span></td>
