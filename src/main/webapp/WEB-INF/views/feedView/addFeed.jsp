...
<link rel="stylesheet" href="/fonts/dropify.woff">
<link rel="stylesheet" href="/fonts/dropify.ttf">
...
<!-- select -->
<script src="/javascript/justselect.min.js"></script>
<link rel="stylesheet" href="/css/justselect.css">
...
function deleteInput() {
	...
	function getkeywords() {
		...
		$.ajax("/search/json/getSearchKeyword",
		  {
			method : "POST",
			dataType : "Json",							
			headers : {
				...
				<div class="col-md-8">
					<div id="main">
						...
						<div class="md-form form-lg">
							<input type="text" id="inputLGEx" class="form-control form-control-lg" name="feedTitle"> <label for="inputLGEx">Write Feed Title</label>
						</div>
						<div class="md-form">
							<input type="text" id="inputMDEx" class="form-control" name="feedExplanation"> <label for="inputMDEx">Write Feed Explanation</label>
						</div>


						<div class="form-group"></div>
						<div id="parah"></div>
						<input type="button" class="btn btn-dark" value="추가" onclick="addInput();" /> <input type="button" class="btn btn-light" value="삭제" onclick="deleteInput();" />
					...
					<div id="side">
						...
						<div>
							<div class="custom-control custom-radio custom-control-inline">
								<input type="radio" class="custom-control-input" id="defaultInline1" name="commentRange" checked="checked" value="0"> <label class="custom-control-label" for="defaultInline1">All</label>
							</div>
							<br>
							<!-- Default inline 2-->
							<div class="custom-control custom-radio custom-control-inline">
								<input type="radio" class="custom-control-input" id="defaultInline2" name="commentRange" value="1"> <label class="custom-control-label" for="defaultInline2">Follower</label>
							</div>
							<br>

							<!-- Default inline 3-->
							<div class="custom-control custom-radio custom-control-inline">
								<input type="radio" class="custom-control-input" id="defaultInline3" name="commentRange" value="2"> <label class="custom-control-label" for="defaultInline3">Disabled</label>
							</div>
						...
						<c:if test="${sessionScope.user.role=='business'}">
							...
							<div>
								...
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" class="custom-control-input" id="defaultInline4" name="feedIsPrime" checked="checked" value="0"> <label class="custom-control-label" for="defaultInline4">Feed</label>
								</div>

								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" class="custom-control-input" id="defaultInline5" name="feedIsPrime" value="1"> <label class="custom-control-label" for="defaultInline5">PrimeFeed</label>
								</div>
							</div>
						</c:if>
		...
		<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="thumbnailModal">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div>
						<strong>썸네일 크기는 4:3으로 업로드 해주세요.</strong> <input type='file' class='dropify' id="thumb" name='uploadFile' accept='image/*' onchange='fileCheck(this)' data-height='400'>
