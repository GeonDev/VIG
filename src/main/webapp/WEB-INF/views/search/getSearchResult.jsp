...
<title>VIG</title>
	...
	function getImagelistFromAjax(item){
		...
		displayValue =
			"<div class = 'view overlay'>"
				+ "<div class = 'img_image'>"
					+ "<a href='/search/getSearchImages?imageId="+ item.imageId +"' class='text-light'>"
					+ "<img src='/images/uploadFiles/" + item.imageFile + "' alt='thumbnail' class='img-fluid rounded-sm ' style='width: auto; height: 300px;'>"
	...
	function getNoSearchResult(){
		...
		displayValue =
			"<div class = 'view overlay'>"								
			+ "<img src='/images/others/noResults.jpg'>"				
			+ "</div>";
	...
	function getUserlistFromAjax(item) {
		...
		displayValue =
			"<div class = 'view'>"
				+"<div class = 'row'>"
					+"<a class = 'col-md-1' href='/myfeed/getMyFeedList?userCode="+ item.userCode + "'>"
					+ "<img src='/images/uploadFiles/" + item.profileImg + "' alt='thumbnail' class='img-fluid rounded-circle ' style=' width: 100%; padding-left: 0px; padding-right: 0px; margin-left : 15px;'>"
					+"</a>"
	...
	function getUserFeedlistFromAjax(item){
		...
		"<div class = 'view_small'>"
			...
			+"<a href='/feed/getFeed?feedId="+ item.feedId +"'>"
			+ "<img src='/images/uploadFiles/" + thumbnail 	+ "' alt='thumbnail' class='img-fluid rounded-sm ' style='width: 125px; height: 100px;'>" 	 							
			+"</a>"
			+"</div>"
		+"</div>";		
